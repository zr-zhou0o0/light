...
public class spotTrigger2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lamp = GameObject.Find("light5d");
        altarla = GameObject.Find("altarla1d");
    ...
    {
        //灯亮之后：可见，激活
        if (lamp.GetComponent<light5controller>().relativeThingActive == 1 && spotActive == 0)
        {
            spotActive = 1;
        ...
        if (altarla.GetComponent<altarla1d>().altarla1Active == 1)
        {
            spot.GetComponent<ParticleSystem>().Stop();
            spotActive = 0;
        }
