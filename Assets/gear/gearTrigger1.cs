...
public class gearTrigger1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        wall1 = GameObject.Find("wall5d");
        wall2 = GameObject.Find("wall7d");
    ...
    void Update()
    {
        ...
        {
            wall1.transform.Translate(new Vector3(0, -1, 0)*0.001f);
            wall2.transform.Translate(new Vector3(0, -1, 0) * 0.001f);
        }
